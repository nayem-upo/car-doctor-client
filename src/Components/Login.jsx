        ...
        <div>
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row gap-56">
                    ...
                    <form onSubmit={handleLogin} className="card flex-shrink-0 w-full max-w-md border rounded-lg py-10">
                        ...
                        <div className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <input className="btn bg-[#FF3811] border-0 text-white" type="submit" value="Sign In" />
                            </div>
                        </div>
                        <h1 className="text-center font-semibold text-lg">Or Sign In with</h1>
                        ...
                        <p className="text-center font-medium">Haven't any account? <Link to="/register"><span className="text-[#FF3811]">Sign Up</span></Link></p>
                    </form>
                </div>
            </div>
        </div>
